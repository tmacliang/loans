...
public abstract class AssertUtils {
    ...
    public static void notLessOrEqualThan(BigDecimal actual, BigDecimal min, ArgumentMessageEnum message) {
    ...
    public static void notMoreThan(BigDecimal actual, BigDecimal min, ArgumentMessageEnum message) {
        if (actual.compareTo(min) > 0) {
            throw new ServerRuntimeException(message.ERROR_CODE, getMessage(true, message.MESSAGE_CODE));
        }
    }
